...
public class TransactionImplementation extends BaseOvservableViewMvc<TransactionViewMVC.Listener>
        implements TransactionViewMVC, SwipeRefreshLayout.OnRefreshListener {
    SwipeRefreshLayout swipeRefreshLayout;
    ProgressBar progressBar;
    public TransactionImplementation(LayoutInflater inflater, ViewGroup parent) {
        setRootView(inflater.inflate(R.layout.activity_transaction,parent,false));
        try {
